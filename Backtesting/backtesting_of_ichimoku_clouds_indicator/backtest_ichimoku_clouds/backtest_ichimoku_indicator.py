...
'''
import math
from Indicators import ichimoku_clouds


def backtest_ichimoku(data, investment, commission=5, stop_loss_pct=0.005, threshold=0):
    """
    ...
    """
    data = ichimoku_clouds.ichimoku_clouds(data)
    signals = data['base_line']
    close = data['close']
    ...
    print(f'Earning from investing $100k by backtest_ichimoku_clouds is ${round(earning, 2)} (ROI = {roi}%)')
