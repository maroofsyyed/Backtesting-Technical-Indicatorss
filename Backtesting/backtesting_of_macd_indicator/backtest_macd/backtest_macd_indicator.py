...
'''
import math
from Indicators import macd_indicator


def backtest_macd(data, investment, commission=5, stop_loss_pct=0.005, threshold=0):
    """
    ...
    """
    macd_line, signal_line, macd_histogram = macd_indicator.calculate_macd(data, short_window=12,
                                                                           long_window=26,
                                                                           signal_window=9)
    signals = signal_line
    close = data['close']
