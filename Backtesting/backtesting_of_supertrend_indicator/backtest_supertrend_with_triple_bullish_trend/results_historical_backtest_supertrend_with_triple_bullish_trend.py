...
from Backtesting.backtesting_of_supertrend_indicator.backtest_supertrend_with_triple_bullish_trend import backtest_supertrend_with_triple_bullish_trend
...
entry, exit, roi, equity =backtest_supertrend_with_triple_bullish_trend.triple_bullish_trend(df, investment, commission=5, share=0, multipliers=[2, 2, 2],
                                        periods=[10, 20, 30], stop_loss_pct=STOP_LOSS_PCT)
